...
/**
 *
 * Check if session is enabled does we call our jwt filter, does it work?
 * Remove session : .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
